...
//                int truth_index = b*locations*(l.classes+1+l.coords)+i*(l.classes+1+l.coords);
                ...
                for (j = 0; j < l.n; ++j) {
                    int p_index = index + locations*l.classes + i*l.n + j; //object confidence
 ...
 * @param thresh //object thresh
 * @param probs  //classes confidence
 * @param boxes  //box(x,y,w,h)
...
void get_detection_boxes(layer l, int w, int h, float thresh, float **probs, box *boxes, int only_objectness)
{
    ...
    for (i = 0; i < l.side*l.side; ++i){
        ...
        for(n = 0; n < l.n; ++n){
            ...
            float scale = predictions[p_index]; //object confidence
            ...
            for(j = 0; j < l.classes; ++j){
                ...
                float prob = scale*predictions[class_index+j]; //conditional class probabilities
