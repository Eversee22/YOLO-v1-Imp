...
void validate_yolo(char *cfgfile, char *weightfile)
{
    ...
    list *plist = get_paths("/home/blacksun2/github/darknet-2016-11-22/VOCdevkit/2007_test.txt");
    ...
    for(j = 0; j < l.side*l.side*l.n; ++j) probs[j] = calloc(classes, sizeof(float/***/)); //should be float?
